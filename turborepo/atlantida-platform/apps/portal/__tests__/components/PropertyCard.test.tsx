...
describe('PropertyCard', () => {
    ...
    describe('Badges', () => {
        ...
        it('renders "Vivienda Promovida" badge when isViviendaPromovida is true', () => {
            render(<PropertyCard {...defaultProps} isViviendaPromovida={true} />)
            expect(screen.getByText('Vivienda Promovida')).toBeInTheDocument()
        })
    })
