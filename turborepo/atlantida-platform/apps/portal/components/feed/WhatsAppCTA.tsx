...
interface WhatsAppCTAProps {
    ...
    onClick: (postId: string, whatsappUrl: string) => void
    phone?: string
    className?: string
}

/**
 * WhatsApp CTA — the highest-value conversion button (+12 pts).
 * Styled with WhatsApp green (#25D366) and prominent sizing.
 */
export function WhatsAppCTA({
    ...
    propertyTitle,
    onClick,
    phone = '+59899000000', // Default placeholder
    className,
}: WhatsAppCTAProps) {
    const message = encodeURIComponent(
        `Hola ${agentName}, vi tu publicación sobre ${propertyTitle} en Barrio.uy y me interesa. ¿Me das más info?`
    )
