...
import { Bed, Ruler, ShieldCheck } from 'lucide-react'
    ...
    return (
        <div className="flex flex-col group h-full">
            ...
            <div className="relative aspect-video w-full overflow-hidden bg-slate-200 dark:bg-slate-700">
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-2">
                    {snapshot.viviendaPromovida && (
                        <span className="bg-white/90 text-slate-900 backdrop-blur-md px-3 py-1 rounded-md text-[10px] font-semibold shadow-sm flex items-center gap-1">
                ...
                {/* ── Bottom Right Price ── */}
                <div className="absolute bottom-4 right-4 bg-slate-900/80 backdrop-blur-md text-white px-4 py-2 rounded-lg">
                    <p className="text-[10px] font-semibold text-slate-300 leading-none mb-1">
                        Destacado
                    </p>
            ...
            <div className="p-5 flex-1 flex flex-col bg-slate-50 dark:bg-slate-800/50">
                ...
                {/* ── Attributes Grid ── */}
                <div className="grid grid-cols-3 gap-2 p-3 bg-white dark:bg-slate-900/50 rounded-lg mb-4 border border-slate-100 dark:border-slate-800">
                    ...
                    {snapshot.acceptedGuarantees.length > 0 && (
                        <div className="flex items-center gap-2 border-l border-slate-200 dark:border-slate-700 pl-2">
                            ...
                            <span className="text-[10px] font-semibold text-slate-500 truncate" title={snapshot.acceptedGuarantees.join(', ')}>
