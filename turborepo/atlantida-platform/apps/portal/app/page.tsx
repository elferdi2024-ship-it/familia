    ...
    <div className="font-display bg-background-light dark:bg-background-dark text-slate-900 dark:text-white min-h-screen pb-32 md:pb-0">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 border-b border-slate-100 dark:border-slate-800">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl md:text-3xl font-black tracking-tighter text-slate-900 dark:text-white">
        ...
        <div className="flex items-center gap-4 overflow-x-auto pb-4 no-scrollbar md:flex-wrap md:justify-center md:overflow-visible md:pb-0">
          {[
            ...
            >
              ...
              >
                <span className={`material-icons text-2xl ${cat.color}`}>
                  {cat.icon}
                </span>
              </div>
        ...
        <div className="bg-slate-900 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden text-white shadow-2xl">
          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/servicios"
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-slate-900 font-black rounded-xl hover:bg-slate-100 transition-all hover:scale-105 active:scale-95 shadow-xl shadow-white/10 gap-2"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Link
                href="/servicios"
                className="bg-white/5 backdrop-blur-sm p-6 rounded-3xl border border-white/10 hover:bg-white/10 transition-colors group"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 border-b border-primary/5">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 md:mb-16 gap-4">
          ...
          <MagneticWrapper>
            <Link
              className="px-6 py-3 rounded-full border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold text-sm flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors flex-shrink-0"
              href="/search"
            >
              Explorar Portfolio{" "}
          ...
          <TiltCard className="md:col-span-2 lg:col-span-2 md:row-span-2 group bg-slate-100 dark:bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all border border-slate-200/50 dark:border-slate-800/50">
            <Link href="/property/1" className="block w-full h-full relative">
              ...
              <div className="absolute top-6 left-6 z-10">
                <span className="bg-primary text-white text-xs font-black uppercase tracking-widest px-4 py-2 rounded-full shadow-sm shadow-primary/30">
                  Bajó de Precio
                </span>
              </div>
              ...
              <div className="absolute bottom-0 inset-x-0 p-8 z-10 text-white">
                <div className="text-3xl font-black mb-2 opacity-90 drop-shadow-md">
                  USD 245.000
                </div>
                <h3 className="font-serif text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-4 drop-shadow-lg group-hover:text-primary transition-colors">
                ...
                <div className="flex items-center gap-6 text-sm font-bold opacity-80 backdrop-blur-sm bg-black/20 px-4 py-2 rounded-2xl w-max">
                  <span className="flex items-center gap-1.5">
                    <span className="material-icons text-[18px]">bed</span> 2
                  </span>
                  <span className="flex items-center gap-1.5">
                    <span className="material-icons text-[18px]">shower</span> 2
                  </span>
                  <span className="flex items-center gap-1.5">
          ...
          <TiltCard className="md:col-span-1 lg:col-span-1 md:row-span-1 group bg-slate-100 dark:bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-lg hover:shadow-xl transition-all border border-slate-200/50 dark:border-slate-800/50">
            <Link href="/property/2" className="block w-full h-full relative">
              ...
              <div className="absolute top-5 left-5 z-10">
                <span className="bg-orange-500 text-white text-[10px] font-black uppercase tracking-wider px-3 py-1.5 rounded-full shadow-lg">
                  Oportunidad
                </span>
              </div>
              <div className="absolute bottom-0 inset-x-0 p-5 z-10 text-white">
                <div className="text-xl font-black mb-1 drop-shadow-sm">
                  USD 580.000
                </div>
                ...
                <div className="flex items-center gap-3 text-xs font-bold opacity-80 bg-black/30 backdrop-blur-md px-3 py-1.5 rounded-xl w-fit">
                  <span className="flex items-center gap-1">
                    <span className="material-icons text-[14px]">bed</span> 4
                  </span>
                  <span className="flex items-center gap-1">
                    <span className="material-icons text-[14px]">shower</span> 3
                  </span>
                  <span className="flex items-center gap-1">
          ...
          <TiltCard className="md:col-span-1 lg:col-span-1 md:row-span-1 group bg-slate-100 dark:bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-lg hover:shadow-xl transition-all border border-slate-200/50 dark:border-slate-800/50">
            <Link href="/property/3" className="block w-full h-full relative">
              ...
              <div className="absolute bottom-0 inset-x-0 p-5 z-10 text-white">
                ...
                <div className="flex items-center gap-3 text-xs font-bold opacity-80 bg-black/30 backdrop-blur-md px-3 py-1.5 rounded-xl w-fit">
                  <span className="flex items-center gap-1">
                    <span className="material-icons text-[14px]">bed</span> 1
                  </span>
                  <span className="flex items-center gap-1">
                    <span className="material-icons text-[14px]">shower</span> 1
                  </span>
                  <span className="flex items-center gap-1">
                    <span className="material-icons text-[14px]">
                      square_foot
          ...
          <TiltCard className="md:col-span-3 lg:col-span-2 md:row-span-1 group bg-white dark:bg-slate-900 rounded-[2.5rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all border border-slate-200/50 dark:border-slate-800/50">
            ...
            >
              ...
              <div className="p-8 flex-1 flex flex-col justify-center bg-slate-50 dark:bg-slate-900 z-10 relative">
                <span className="inline-block px-3 py-1 bg-green-500/10 text-green-600 dark:text-green-400 text-[10px] font-black uppercase tracking-wider rounded-full self-start mb-4 border border-green-500/20 shadow-sm backdrop-blur-sm">
                  Recién Ingresado
                </span>
                <div className="text-3xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">
                  USD 315.000
                </div>
                <h3 className="font-serif text-2xl md:text-3xl font-black text-slate-800 dark:text-slate-100 leading-tight mb-4 group-hover:text-primary transition-colors">
                ...
                <div className="flex items-center gap-4 text-slate-500 dark:text-slate-400 text-sm font-bold mt-auto h-fit">
                  <span className="flex items-center gap-1 bg-white/50 dark:bg-black/20 px-2 py-1 rounded-lg">
                    <span className="material-icons text-[16px]">bed</span> 1
                  </span>
                  <span className="flex items-center gap-1 bg-white/50 dark:bg-black/20 px-2 py-1 rounded-lg">
                    <span className="material-icons text-[16px]">shower</span> 1
                  </span>
                  <span className="flex items-center gap-1 bg-white/50 dark:bg-black/20 px-2 py-1 rounded-lg">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 mb-12 md:mb-20">
        <div className="bg-primary/5 dark:bg-primary/10 rounded-xl p-6 md:p-12 flex flex-col md:flex-row items-center gap-8 md:gap-12 border border-primary/10">
          <div className="flex-1">
            <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight mb-3 md:mb-4">
              ¿Buscás por zona?
            </h2>
            ...
            <Link
              ...
              className="bg-primary text-white px-6 md:px-8 py-3.5 md:py-4 rounded-full font-bold shadow-xl shadow-primary/30 hover:shadow-primary/50 transition-all flex items-center gap-2 max-w-fit text-sm md:text-base"
            >
