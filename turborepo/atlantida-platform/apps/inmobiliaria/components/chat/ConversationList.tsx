...
interface ConversationListProps {
  agentId: string
  /** En Inmobiliaria no se usa restricción por plan: todos tienen acceso (interno/familiar). */
  userPlan?: "free" | "pro" | "premium" | "elite"
}

/** Bandeja de conversaciones. En esta app siempre muestra la lista completa (uso interno). */
