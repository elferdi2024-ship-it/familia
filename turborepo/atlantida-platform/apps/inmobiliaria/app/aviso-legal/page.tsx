...
export const metadata: Metadata = {
    title: "Aviso Legal | MiBarrio.uy",
    description: "Propiedad intelectual, derechos de autor y aviso legal de la plataforma MiBarrio.uy.",
}
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 md:p-12 shadow-sm border border-slate-100 dark:border-slate-800 text-slate-600 dark:text-slate-300 space-y-8 leading-relaxed">
                    ...
                    <section>
                        ...
                        <p className="mt-4">
                            El presente Aviso Legal regula la propiedad intelectual y el uso del software y la plataforma <strong>MiBarrio.uy</strong>.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>
                            El software, código fuente, diseño, arquitectura, bases de datos, algoritmos y toda la tecnología que compone <strong>Atlantida Platform</strong> (incluyendo MiBarrio.uy y cualquier producto derivado) son propiedad exclusiva de Atlantida Platform y/o sus titulares.
                        </p>
                    ...
                    <section>
                        ...
                        <p>
                            Los nombres <strong>MiBarrio.uy</strong>, <strong>Atlantida Platform</strong> y los logotipos asociados son marcas registradas o en proceso de registro. Su uso no autorizado constituye infracción.
                        </p>
                    </section>
