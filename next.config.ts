        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://maps.googleapis.com https://maps.gstatic.com https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://*.googleapis.com https://firebasestorage.googleapis.com https://vercel.live https://accounts.google.com https://www.googleapis.com",
              "frame-src 'self' https://vercel.live https://accounts.google.com https://content.googleapis.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
